...
const DEPOIMENTOS_FALLBACK: Review[] = [
  {
    ...
    nome: 'Marina S.',
    cidade: 'Fortaleza, CE',
    texto: 'Recebi a Mykaele em casa e o resultado apareceu já na primeira sessão. Redução real de medidas, com toda a estrutura montada na minha sala — não precisei sair para nada.',
  ...
  },
  {
    ...
    nome: 'Carolina O.',
    cidade: 'Fortaleza, CE',
    texto: 'O Home Spa chegou montado na minha casa: ambiente, aroma, cada detalhe. Vivi a experiência sem trânsito, sem espera, no meu próprio tempo. E os resultados se mantêm.',
  ...
  },
  {
    ...
    nome: 'Beatriz C.',
    cidade: 'Fortaleza, CE',
    texto: 'A Arquitetura Corporal é diferente de tudo que já experimentei — protocolo sério e resultados que dá pra medir. E tudo acontecendo na privacidade da minha casa, no horário que combinei.',
  ...
  },
  {
    ...
    nome: 'Amanda F.',
    cidade: 'Fortaleza, CE',
    texto: 'O protocolo é todo pensado para o meu corpo e para a minha rotina. A Mykaele leva tudo até mim — sessão impecável, sem eu sair de casa. Resultado natural e duradouro.',
